        ...
        <div class="row">
            <div class="col-md-3 divLeft">
                ...
                <div class="divLien">
                    ...
                    <a  href="addPlan.php" class="btn btn-outline-primary lien">Ajoutre un plan </a>
            ...
            <div class="offset-md-3  col-md-8 ">
                ...
                <form action="post">
                    <div class="row selectePlan">
                        ...
                        <div class="col-md-4">
                            <h2><span class='nombrePlan'><?=sizeof($type_plan)?></span>  </h2>
                        </div>
                    </div>
                </form>
                <!--selection du type de plan -->
                ...
                <section>
                    <div class="imagesPlan row">
                        ...
                        <div class="col-md-6">
                            <h2> TITRE DU PLAN ...</h2>
                                <img src="../../images/imagesPlan/<?=$imagesPlan?>" alt="" width="90%" height="auto">
                            <div class="row ligne">
                                <div class="col-sm voir">
                                    <a href="viewMaison.php?id=<?=$id_Plan?>" class=""><i class="far fa-home-lg-alt"></i> Voir</a>
                                </div>
